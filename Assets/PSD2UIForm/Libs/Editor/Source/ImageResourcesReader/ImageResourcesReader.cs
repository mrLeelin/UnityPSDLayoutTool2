...
internal class ImageResourcesReader : PropertySectionReader
{
	public ImageResourcesReader(PsdBigEndianReader P_0)
		: this(global::Psd2UIForm.Reconstruction.ConstructorGuards.Evaluate(), P_0)
	{
	}

	private ImageResourcesReader(global::Psd2UIForm.Reconstruction.ConstructorGuardToken constructorGuards, PsdBigEndianReader P_0)
		: base(P_0, null)
	{
	}
	...
	protected override void ReadSectionValue(PsdBigEndianReader P_0, object P_1, out IProperties P_2)
	{
		...
		while (P_0.Position < GetSectionEndPosition())
		{
			...
			string text = P_0.ReadInt16().ToString();
			P_0.ReadPaddedPascalString(2);
