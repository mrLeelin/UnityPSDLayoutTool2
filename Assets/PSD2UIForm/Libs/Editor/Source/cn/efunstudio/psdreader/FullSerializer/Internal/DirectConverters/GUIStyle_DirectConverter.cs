...
public class GUIStyle_DirectConverter : fsDirectConverter<GUIStyle>
{
	...
	protected override fsResult DoDeserialize(Dictionary<string, fsData> data, ref GUIStyle model)
	{
		...
		fsResult fsResult = success + DeserializeMember<GUIStyleState>(data, null, "active", out value);
		model.active = value;
		TextAnchor value2 = model.alignment;
		fsResult fsResult2 = fsResult + DeserializeMember<TextAnchor>(data, null, "alignment", out value2);
	...
	private GUIStyle_DirectConverter(global::Psd2UIForm.Reconstruction.ConstructorGuardToken constructorGuards)
		: base()
	{
	}
}
