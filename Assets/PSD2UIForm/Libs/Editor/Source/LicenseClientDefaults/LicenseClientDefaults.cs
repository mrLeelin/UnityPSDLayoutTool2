...
internal static class LicenseClientDefaults
{
	internal static PsdReaderLicenseClientConfigDocument CreateClientConfig()
	{
		...
		psdReaderLicenseClientConfigDocument.CurrentMajorVersion = PsdProductVersionAccessor.GetCurrentMajorVersion();
		return psdReaderLicenseClientConfigDocument;
	}

	internal static string GetPublicKeyPem()
	{
