...
[PsdBlockSignatureAttribute("lsdk")]
internal class SectionDividerKeyResourceReader : PsdResourceReader
{
	public SectionDividerKeyResourceReader(PsdBigEndianReader P_0, long P_1)
		: this(global::Psd2UIForm.Reconstruction.ConstructorGuards.Evaluate(), P_0, P_1)
	{
	}

	private SectionDividerKeyResourceReader(global::Psd2UIForm.Reconstruction.ConstructorGuardToken constructorGuards, PsdBigEndianReader P_0, long P_1)
		: base(P_0, P_1)
	{
	}
