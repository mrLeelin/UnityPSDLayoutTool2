    ...
    public sealed class TMPInputFieldHelper : UIHelperBase
    {
        ...
        protected override void InitUIElements(GameObject uiRoot)
        {
            ...
            if (!((Object)(object)component == (Object)null))
            {
                ...
                UGUIParser.ApplyNodeRectToUI(placeholder, val2);
                UGUIParser.ApplyNodeRectToUI(text, val3);
                UGUIParser.ApplyTMPTextStyle(placeholder, val2);
                UGUIParser.ApplyTMPTextStyle(text, val3);
