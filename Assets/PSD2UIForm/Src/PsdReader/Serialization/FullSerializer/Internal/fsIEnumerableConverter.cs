...
namespace cn.efunstudio.psdreader.FullSerializer.Internal
{
    ...
    {
        private static fsIEnumerableConverter s_ObfuscationSentinel;
        ...
        public override fsResult TryDeserialize(fsData data, ref object instance_, Type storageType)
        {
            IEnumerable enumerable = (IEnumerable)instance_;
            fsResult success = fsResult.Success;
            fsResult fsResultA = (success += CheckType(data, fsDataType.Array));
            if (fsResultA.Failed)
            {
                return success;
            }
        ...
        internal static fsIEnumerableConverter GetObfuscationSentinel()
        {
