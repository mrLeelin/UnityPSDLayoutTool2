...
namespace cn.efunstudio.psdreader.FullSerializer.Internal
{
    ...
    {
        internal static fsDictionaryConverter s_ObfuscationSentinel;
        ...
        public override fsResult TryDeserialize(fsData data, ref object instance_, Type storageType)
        {
            ...
            if (!data.IsList)
            {
                ...
                foreach (KeyValuePair<string, fsData> item in data.AsDictionary)
                {
                    ...
                    if (!result3.Failed)
                    {
                        fsResult fsResultA = (success += Serializer.TryDeserialize(value, valueStorageType, ref result2));
                        if (!fsResultA.Failed)
                        {
        ...
        public override fsResult TrySerialize(object instance_, out fsData serialized, Type storageType)
        {
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    {
                        fsData fsData = list[j];
                        fsData value3 = list2[j];
                        asDictionary[fsData.AsString] = value3;
                    }
                }
                return success;
            }
        ...
        internal static fsDictionaryConverter GetObfuscationSentinel()
        {
