...
namespace cn.efunstudio.psdreader.FullSerializer.Internal
{
    ...
    {
        private static fsKeyValuePairConverter s_ObfuscationSentinel;
        ...
        public override fsResult TryDeserialize(fsData data, ref object instance, Type storageType)
        {
            ...
            fsData subitem;
            fsResult fsResultA = (success += CheckKey(data, "Key", out subitem));
            if (fsResultA.Failed)
            {
                return success;
            }
        ...
        internal static fsKeyValuePairConverter GetObfuscationSentinel()
        {
