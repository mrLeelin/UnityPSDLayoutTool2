...
{
    public sealed class fsReflectionUtility
    {
        internal static fsReflectionUtility s_ObfuscationSentinel;
        ...
        internal static fsReflectionUtility GetObfuscationSentinel()
        {
