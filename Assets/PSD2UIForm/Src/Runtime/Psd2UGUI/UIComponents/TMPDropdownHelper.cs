...
namespace UGF.EditorTools.Psd2UGUI
{
    ...
    public sealed class TMPDropdownHelper : UIHelperBase
    {
        ...
        protected override void InitUIElements(GameObject uiRoot)
        {
            ...
            EditorHost?.ApplyTMPTextStyle(psdLayerNode, (captionText is TextMeshProUGUI) ? captionText : null);
            EditorHost?.ApplyNodeRectToUI(label, component.captionText);
            ...
            {
                EditorHost?.ApplyNodeRectToUI(arrow, val2);
                EditorHost?.ApplyImageSprite(arrow, val2);
            }
            ...
            else
            {
                ...
                if ((Object)(object)val3 != (Object)null)
                {
                    ...
                    EditorHost?.ApplyNodeRectToUI(scrollView, component2);
                }
            }
