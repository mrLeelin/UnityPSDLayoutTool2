...
namespace cn.efunstudio.psdreader.FullSerializer.Internal
{
    public class fsCyclicReferenceManager
    {
        private class ObjectReferenceEqualityComparator : IEqualityComparer<object>
        {
            ...
            internal static ObjectReferenceEqualityComparator s_ObfuscationSentinel;
            ...
            internal static ObjectReferenceEqualityComparator GetObfuscationSentinel()
            {
        ...
        private static fsCyclicReferenceManager s_ObfuscationSentinel;
        ...
        internal static fsCyclicReferenceManager GetObfuscationSentinel()
        {
            return s_ObfuscationSentinel;
        }
    }
