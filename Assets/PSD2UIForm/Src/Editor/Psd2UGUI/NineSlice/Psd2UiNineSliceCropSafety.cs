namespace UGF.EditorTools.Psd2UGUI.NineSlice
{
    ...
    /// </summary>
    internal static class Psd2UiNineSliceCropSafety
    {
        ...
        private static int MapToCroppedCoordinate(int sourceCoordinate, int sourceSize, int croppedSize, int leading, int trailing)
        {
            ...
            return leading + ((sourceCoordinate - leading) * Psd2UiNineSliceBorder.MinimumStretchCenterPixels / sourceCenterSize);
        }
    }
}
