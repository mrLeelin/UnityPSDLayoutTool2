namespace UGF.EditorTools.Psd2UGUI.NineSlice
{
    ...
    /// </summary>
    public static class Psd2UiNineSliceUnityAutoProcessor
    {
        /// <summary>
            ...
            out string reason)
        {
            ...
            Psd2UiNineSliceRaster sourceRaster;
            Psd2UiNineSliceRaster sourceResult;
            Psd2UiNineSliceBorder sourceBorder;
            ...
            try
            {
                ...
                Psd2UiNineSliceRaster scaledRaster = ToTopLeftRaster(scaled);
                ...
                Psd2UiNineSliceNameRule scaledRule = new Psd2UiNineSliceNameRule(rule.Mode, border);
        ...
        private static bool TryBuildSourceConversion(
            Texture2D source,
            Psd2UiNineSliceNameRule rule,
            out Psd2UiNineSliceRaster sourceRaster,
            out Psd2UiNineSliceRaster sourceResult,
            out Psd2UiNineSliceBorder sourceBorder,
            out string reason)
        {
            sourceRaster = null;
            sourceResult = null;
            ...
            try
            {
                ...
                return Psd2UiNineSliceAutoProcessor.TryProcessRaster(
                    sourceRaster,
                    rule,
                    out sourceResult,
                    out sourceBorder,
            ...
            out string reason)
        {
            ...
            try
            {
                Psd2UiNineSliceRaster cropped;
                if (!Psd2UiNineSliceAutoProcessor.TryProcessRaster(raster, rule, out cropped, out border, out reason))
                {
                    return false;
                }
        ...
        /// </summary>
        private static Psd2UiNineSliceRaster ToTopLeftRaster(Texture2D texture)
        {
            ...
            return new Psd2UiNineSliceRaster(texture.width, texture.height, pixels);
        }

        private static byte[] EncodeTopLeftRaster(Psd2UiNineSliceRaster raster)
        {
