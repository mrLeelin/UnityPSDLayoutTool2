namespace UGF.EditorTools.Psd2UGUI.NineSlice
{
    ...
    /// </summary>
    public static class Psd2UiNineSliceCropper
    {
        private const int StretchSampleSize = Psd2UiNineSliceBorder.MinimumStretchCenterPixels;
        ...
        /// </summary>
        public static Psd2UiNineSliceRaster CropToMinimum(Psd2UiNineSliceRaster source, Psd2UiNineSliceBorder border)
        {
            if (source == null)
            {
            ...
            return new Psd2UiNineSliceRaster(targetWidth, targetHeight, targetPixels);
        }
