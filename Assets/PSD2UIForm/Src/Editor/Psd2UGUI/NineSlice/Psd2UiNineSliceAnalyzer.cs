namespace UGF.EditorTools.Psd2UGUI.NineSlice
{
    ...
    /// </summary>
    public static class Psd2UiNineSliceAnalyzer
    {
        ...
        /// </summary>
        public static bool TryInfer(Psd2UiNineSliceRaster raster, out Psd2UiNineSliceInference inference)
        {
            inference = null;
            ...
            Psd2UiNineSliceBorder visual = InferVisualEdges(raster);
            Psd2UiNineSliceBorder repeated = InferRepeatedEdges(raster);
            Psd2UiNineSliceBorder merged = Merge(visual, repeated, raster.Width, raster.Height);
            ...
            inference = new Psd2UiNineSliceInference(
                merged,
                Psd2UiNineSliceConfidence.Medium,
                roundRectBorder > 0 ? "visual-repeat-round-rect" : "visual-repeat");
            return true;
        }

        private static bool HasVisiblePixels(Psd2UiNineSliceRaster raster)
        {
        ...
        private static Psd2UiNineSliceBorder InferVisualEdges(Psd2UiNineSliceRaster raster)
        {
        ...
        private static Psd2UiNineSliceBorder InferRepeatedEdges(Psd2UiNineSliceRaster raster)
        {
            return new Psd2UiNineSliceBorder(
        ...
        private static Psd2UiNineSliceBorder Merge(Psd2UiNineSliceBorder visual, Psd2UiNineSliceBorder repeat, int width, int height)
        {
            return new Psd2UiNineSliceBorder(
        ...
        private static int FindRepeatEdge(Psd2UiNineSliceRaster raster, bool scanColumns, bool fromStart)
        {
        ...
        private static bool LinesEqual(Psd2UiNineSliceRaster raster, bool scanColumns, int first, int second)
        {
        ...
        private static int InferRoundRectBorder(Psd2UiNineSliceRaster raster)
        {
            int[] insets =
            {
        ...
        private static Psd2UiNineSliceBorder ProtectRoundCorners(Psd2UiNineSliceBorder border, int roundedBorder, int width, int height)
        {
        ...
        private static int FindAlphaInsetOnRow(Psd2UiNineSliceRaster raster, int y, bool fromStart)
        {
        ...
        private static int FindAlphaInsetOnColumn(Psd2UiNineSliceRaster raster, int x, bool fromStart)
        {
        ...
        private static RgbaSample AverageRow(Psd2UiNineSliceRaster raster, int y, int x0, int x1)
        {
        ...
        private static RgbaSample AverageColumn(Psd2UiNineSliceRaster raster, int x, int y0, int y1)
        {
            RgbaSample total = new RgbaSample();
            int count = 0;
        ...
        private struct RgbaSample
        {
            ...
            public void Add(Psd2UiNineSliceRaster raster, int x, int y)
            {
