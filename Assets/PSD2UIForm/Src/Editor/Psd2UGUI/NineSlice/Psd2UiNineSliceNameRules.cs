namespace UGF.EditorTools.Psd2UGUI.NineSlice
{
    ...
    /// </summary>
    public enum Psd2UiNineSliceMode
    {
        NineSlice,
    ...
    /// </summary>
    public sealed class Psd2UiNineSliceNameRule
    {
        public Psd2UiNineSliceNameRule(Psd2UiNineSliceMode mode, Psd2UiNineSliceBorder explicitBorder)
        {
            Mode = mode;
            ExplicitBorder = explicitBorder;
        }

        public Psd2UiNineSliceMode Mode { get; private set; }
        public Psd2UiNineSliceBorder ExplicitBorder { get; private set; }
    ...
    /// </summary>
    public static class Psd2UiNineSliceNameRules
    {
        ...
        /// </summary>
        public static bool TryParse(string layerName, out Psd2UiNineSliceNameRule rule)
        {
            rule = null;
            ...
            if (explicitMatch.Success)
            {
                ...
                rule = new Psd2UiNineSliceNameRule(
                    Psd2UiNineSliceMode.NineSlice,
                    new Psd2UiNineSliceBorder(
        ...
        private static bool TryCreateRule(string value, out Psd2UiNineSliceNameRule rule)
        {
            rule = null;
            ...
            {
                rule = new Psd2UiNineSliceNameRule(Psd2UiNineSliceMode.HorizontalThreeSlice, null);
                return true;
            }
            ...
            {
                rule = new Psd2UiNineSliceNameRule(Psd2UiNineSliceMode.VerticalThreeSlice, null);
                return true;
            }
